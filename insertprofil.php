...
if (!empty($_POST) AND !empty($_FILES)) {
	...
	if ($isSuccess && $isUploadSuccess) {
		$reqinsert = $bd->prepare('INSERT INTO utilisateursprofil (description, imagesprofil, id_utilisateur) VALUES (?,?,?)');
		$reqinsert->execute(array($description, $images, $_SESSION['id']));
